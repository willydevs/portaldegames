...
const Footer = () => {
    ...
    return (
        <footer className="bg-gray-50 border-t border-gray-200 pt-16">
            <div className="container mx-auto px-4 md:px-6">

                {/* Partners Section */}
                <div className="mb-16">
                    <div className="flex items-center justify-between mb-8">
                        <h3 className="text-2xl font-bold text-gray-900">Nossos Parceiros / Projetos</h3>
                    </div>
                ...
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8 mb-16 text-center md:text-left">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900 mb-2">Downloads Seguros e Confiáveis</h2>
                    ...
                    <div className="flex flex-col items-center gap-3 shrink-0">
                        ...
                        <div className="flex items-center gap-2 text-sm text-green-700 font-medium bg-green-50 px-3 py-1 rounded-full">
